...
7: {
    ...
    details: `
        ...
        <ul>
            ...
            <li>Размещение вакансии на всех возможных платформах</li>
...
8: {
    ...
    details: `
        ...
        <ul>
            ...
            <li>Пропишем регламент работы</li>
            <li>Скрипты продаж</li>
            <li>Разработка общей стратегии</li>
        </ul>
    `,
...
9: {
    ...
    details: `
        ...
        <ul>
            ...
            <li>Объем выручки</li>
            <li>Количество касании в день</li>
            <li>Оперативность отклика на входящую заявку</li>
            <li>Конверсия</li>
            <li>Истиная причина оттока клиентов</li>
            <li>Анализ каждого сотрудника персонально</li>
        </ul>
    `,
